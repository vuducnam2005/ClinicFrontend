    ...
    routes: [
...

      {
        ...
        children: [
          ...
          { path: 'inventory-slips', name: 'nurse-inventory-slips', component: () => import('@/pages/nurse/NurseInventorySlipsPage.vue') },
...

      {
        ...
        children: [
          ...
          { path: 'inventory-slips', name: 'admin-inventory-slips', component: () => import('@/pages/admin/AdminInventoryApprovalPage.vue') },
