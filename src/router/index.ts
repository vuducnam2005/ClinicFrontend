    ...
    routes: [
...

      {
        ...
        children: [
          ...
          { path: 'records', name: 'patient-records', component: () => import('@/pages/patient/PatientResourcePage.vue'), meta: { patientResource: 'records' } },
          { path: 'prescriptions', name: 'patient-prescriptions', component: () => import('@/pages/patient/PatientResourcePage.vue'), meta: { patientResource: 'prescriptions' } },
