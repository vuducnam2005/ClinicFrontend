<template>
  <div>
    ...
    <div v-else-if="displaySlots.length" class="grid grid-cols-3 gap-2 sm:grid-cols-5 lg:grid-cols-7">
      <button
...
function slotClass(slot: string) {
  if (isBooked(slot)) return 'border-rose-300 bg-rose-50 text-rose-700 opacity-100'
